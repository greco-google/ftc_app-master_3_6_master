...
/**
 * Created by zahs on 1/11/2018.
 */
@Autonomous(name = "Red1" , group = "test")
public class R1 extends OpMode {
        ...
        switch (CurrentState) {
            ...
            case STATE_INITIAL:
                if (Runtime.milliseconds() > 500) {
                    while (20 < robot.robotStuff.colorSensor.red()) {
                    ...
                    while (20 < robot.robotStuff.colorSensor.blue()) {
                        robot.robotStuff.FLeft.setPower(1);
                        robot.robotStuff.FRight.setPower(1);
                        robot.robotStuff.BLeft.setPower(1);
                        robot.robotStuff.BRight.setPower(1);
            ...
            case STATE_COLOR:
                ...
                break;
            case STATE_STOP:
                if (Runtime.milliseconds() > 250) {  //at 2000
                    robot.stop();
                    robot.robotStuff.relicArmLift.setPower(0);
                    robot.robotStuff.relicArmExtends.setPower(0);}
                break;
